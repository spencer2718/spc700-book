...
`v0.1.0` is the first end-to-end verified release. Tooling is
proven on Asar 1.91 (assembly) and Mesen2 latest stable (emulation,
on Windows). Chapter 13 produces audible output in the emulator,
and the IPL upload protocol is confirmed working on both critical-
path exercises.
...
| 13 | Voices, Pitch, and Envelopes            | scaffolded, builds clean| yes       |
...
PASS_CONDITIONS have been observed in Mesen2.
