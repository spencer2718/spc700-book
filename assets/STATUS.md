...
|---:|-----------------------------------------|-------------------|-----------|
| 5  | Interlude: Setting Up                   | scaffolded        | no        |
...
| 13 | Voices, Pitch, and Envelopes            | scaffolded        | no        |
...
solution, and PASS_CONDITIONS exist as drafts. The drafts have been
read for plausibility but have not been built and run on real
tooling.
